...
const CommandLine = (props) => {
    ...
    //----------CONSTANTS------------------
    //------------STATES---------------------
    const [currentCommand, setCurrentCommand] = useState(commandHistory[commandHistory.length-1]) //input box value
    //---------------REFS-------------------------------------------------
    ...
    const onCommandKeyUp = useCallback((e)=>{
    ...
    },[computeCurrentCommand, currentCallId,
        setCommandHistory, ])
